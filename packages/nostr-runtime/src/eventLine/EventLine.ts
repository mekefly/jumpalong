...
export class EventLineEmitter<Config extends EventLineConfig = {}> {
  ...
  emit<TYPE extends keyof Config['emits']>(
    ...
    ;(this.emitWithOption as any)(type, rest)
    return this
  }
   ...
   * @returns
   */
  emitWithOption<TYPE extends keyof Config['emits']>(
    type: TYPE,
    ...rest: [
      //第二个参数,如果为数组可以忽略
      ...rest: (
    ...
    returnListener && this.emitter.returnEmitter.on(type, returnListener as any)
    return this
  }
