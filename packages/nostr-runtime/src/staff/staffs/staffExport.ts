...
import {default as ReadWriteListStaff} from './api/ReadWriteListStaff';
...
type ReadWriteListStaffConfigType = StaffConfigType<typeof ReadWriteListStaff>
