...
type ChannelMetadataApiStaffConfigType = StaffConfigType<
  typeof ChannelMetadataApiStaff
>
...
type AutoAddKind10002UrlStaffConfigType = StaffConfigType<
  typeof AutoAddKind10002UrlStaff
>
type AutoAddUrlByGlobalDiscoveryUserStaffConfigType = StaffConfigType<
  typeof AutoAddUrlByGlobalDiscoveryUserStaff
>
type DefaultUrlStaffConfigType = StaffConfigType<typeof DefaultUrlStaff>
type GlobalDiscoveryUserStaffConfigType = StaffConfigType<
  typeof GlobalDiscoveryUserStaff
>
...
type InsertObjectListStaffConfigType = StaffConfigType<
  typeof InsertObjectListStaff
>
type Kind10002ReadWriteListConfigStaffConfigType = StaffConfigType<
  typeof Kind10002ReadWriteListConfigStaff
>
...
type ReverseSearchInsertOnObjectListStaffConfigType = StaffConfigType<
  typeof ReverseSearchInsertOnObjectListStaff
>
type SearchInsertOnObjectListStaffConfigType = StaffConfigType<
  typeof SearchInsertOnObjectListStaff
>
...
type PublishedEventListStaffConfigType = StaffConfigType<
  typeof PublishedEventListStaff
>
...
type WebSocketFactoryStaffConfigType = StaffConfigType<
  typeof WebSocketFactoryStaff
>
...
type TimeoutAutoUnSubStaffConfigType = StaffConfigType<
  typeof TimeoutAutoUnSubStaff
>
type RelayConfiguratorSynchronizerAddUrlsStaffConfigType = StaffConfigType<
  typeof RelayConfiguratorSynchronizerAddUrlsStaff
>
export {
  AddFilterStaff,
  AddPublishStaff,
  ...
  PublishEmitStaff,
  PublishStaff,
  PublishedEventListStaff,
  ReactionStaff,
  ReactiveStaff,
  RelayConfiguratorSynchronizerAddUrlsStaff,
  RelayEmitterStaff,
  RelayLifecycleStaff,
  ReverseSearchInsertOnObjectListStaff,
  SearchInsertOnObjectListStaff,
  SubEmitStaff,
  SubIdListStaff,
  SubStaff,
...
export type {
  AddFilterStaffConfigType,
  AddPublishStaffConfigType,
  AddRelayUrlsConfigType,
  AddUrlStaffConfigType,
  AddUrlsByCueStaffConfigType,
  AddressPointerApiConfigType,
  ApiAddUrlsStaffConfigType,
  AsyncCallStaffConfigType,
  AuthStaffConfigType,
  AutoAddKind10002UrlStaffConfigType,
  AutoAddUrlByGlobalDiscoveryUserStaffConfigType,
  CachedStaffConfigType,
  ChannelMetadataApiStaffConfigType,
  CloseRelayStaffConfigType,
  ConfigStaffConfigType,
  ContactApiStaffConfigType,
  CreateIdStaffConfigType,
  DefaultUrlStaffConfigType,
  DeletionStaffApiConfigType,
  DoNotRepeatStaffConfigType,
  EoseAutoUnSubStaffConfigType,
  EoseStaffConfigType,
  EventApiStaffConfigType,
  EventByIdApiStaffConfigType,
  EventCreateAtStaffConfigType,
  EventListStaffConfigType,
  EventStaffConfigType,
  EventUtilsStaffConfigType,
  FilterStaffConfigType,
  FilterStopStaffConfigType,
  GlobalDiscoveryUserStaffConfigType,
  GlobalUrlsStaffConfigType,
  InsertObjectListStaffConfigType,
  Kind10002ReadWriteListConfigStaffConfigType,
  LatestEventStaffConfigType,
  LoadStaffConfigType,
  LocalMapStaffConfigType,
  LoginStaffConfigType,
  LoginUtilsStaffConfigType,
  ManagerStaffConfigType,
  MetadataStaffConfigType,
  NostrApiStaffConfigType,
  NostrModeStaffConfigType,
  NoticeStaffConfigType,
  OkStaffConfigType,
  PoolStaffConfigType,
  PublishEmitStaffConfigType,
  PublishStaffConfigType,
  PublishedEventListStaffConfigType,
  ReactionStaffConfigType,
  ReactiveStaffConfigType,
  RelayConfiguratorSynchronizerAddUrlsStaffConfigType,
  RelayEmitterStaffConfigType,
  RelayLifecycleStaffConfigType,
  ReverseSearchInsertOnObjectListStaffConfigType,
  SearchInsertOnObjectListStaffConfigType,
  SubEmitStaffConfigType,
  SubIdListStaffConfigType,
  SubStaffConfigType,
  TimeoutAutoUnSubStaffConfigType,
  UserApiStaffConfigType,
  WebSocketFactoryStaffConfigType,
}
